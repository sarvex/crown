...
public class TransformPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string    (_component_id, "type", OBJECT_TYPE_TRANSFORM);

		_db.add_restore_point((int)ActionType.SET_TRANSFORM, new Guid[] { _id });
	}
...
public class MeshRendererPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_MESH_RENDERER);

		_db.add_restore_point((int)ActionType.SET_MESH, new Guid[] { _id });
	}
...
public class SpriteRendererPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_bool  (_component_id, "data.visible", _visible.value);
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_SPRITE_RENDERER);

		_db.add_restore_point((int)ActionType.SET_SPRITE, new Guid[] { _id });
	}
...
public class LightPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string (_component_id, "type", OBJECT_TYPE_LIGHT);

		_db.add_restore_point((int)ActionType.SET_LIGHT, new Guid[] { _id });
	}
...
public class CameraPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_CAMERA);

		_db.add_restore_point((int)ActionType.SET_CAMERA, new Guid[] { _id });
	}
...
public class ColliderPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_COLLIDER);

		_db.add_restore_point((int)ActionType.SET_COLLIDER, new Guid[] { _id });
	}
...
public class ActorPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_ACTOR);

		_db.add_restore_point((int)ActionType.SET_ACTOR, new Guid[] { _id });
	}
...
public class ScriptPropertyGrid : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_SCRIPT);

		_db.add_restore_point((int)ActionType.SET_SCRIPT, new Guid[] { _id });
	}
...
public class AnimationStateMachine : PropertyGrid
{
	...
	private void on_value_changed()
	{
		...
		unit.set_component_property_string(_component_id, "type", OBJECT_TYPE_ANIMATION_STATE_MACHINE);

		_db.add_restore_point((int)ActionType.SET_ANIMATION_STATE_MACHINE, new Guid[] { _id });
	}
